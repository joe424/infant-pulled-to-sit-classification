...
#         self.l1 = TCN_GCN_unit(in_channels, out_channels // 2, A, stride=2, residual=False, frames=frames) ###
#         self.l2 = TCN_GCN_unit(out_channels // 2, out_channels, A, stride=2, frames=frames//2) ###
