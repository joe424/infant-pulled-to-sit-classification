...
class Base(object):
    ...
    def load_weights(self, model=None):
        ...
        model = '/home/mbl/infant_development_evaluation_project/posetrack/lighttrack/weights/MSRA152/MSRA_snapshot_285.ckpt'
        print("load_weights:osp.exists(model)", osp.exists(model))
...
class Trainer(Base):
    ...
    def train(self):
        ...
        for itr in range(start_itr, self.cfg.max_itr + nr_itrs, nr_itrs):
            ...
            if np.any(itrs % self.cfg.epoch_size*10 == 0):
