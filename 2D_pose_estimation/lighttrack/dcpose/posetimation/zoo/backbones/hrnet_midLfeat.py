...
BN_MOMENTUM = 0.1
__all__ = ["HRNet_midLfeat", "HighResolutionModule"]


@MODEL_REGISTRY.register()
class HRNet_midLfeat(BaseModel):
    ...
    def get_net(cls, cfg, phase, **kwargs):
        model = HRNet_midLfeat(cfg, phase, **kwargs)
        return model

    def __init__(self, cfg, phase, **kwargs):
        super(HRNet_midLfeat, self).__init__()
    ...
    def forward(self, x, **kwargs):
        ...
        if self.use_deconv:
            ...
            return rough_pose_heatmaps, x3_list[0]
