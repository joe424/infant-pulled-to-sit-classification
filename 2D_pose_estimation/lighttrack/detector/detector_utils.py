...
def preprocess_img_for_yolo(img, img_size=416):
    ...
    input_img = Resize(img_size)(img).unsqueeze(0)
...
def non_max_suppression(prediction, conf_thres=0.5, nms_thres=0.4):
    ...
    for image_i, image_pred in enumerate(prediction):
        ...
        # print("class_preds:{}, conf:{} ".format(class_preds, image_preds[5:]))
        detections = torch.cat((image_pred[:, :5], class_preds), 1)
        
        #keep_boxes = detections
        #output[image_i] = keep_boxes
        #print("keep_boxes", keep_boxes.size())
        #print("num bbx: {}".format(detections.size()))
        #print("num bbx_content: {}".format(detections))
        ...
        if keep_boxes:
            ...
            # print(torch.stack(keep_boxes).size())
        #"""
